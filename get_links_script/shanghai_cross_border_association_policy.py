...
def extract_links(text):
    """从文本中提取指定格式的链接"""
    # https://www.scea.co/policy/show/id/3339.html
...
async def crawl_page(page_num: int, links_list: list, crawler, run_config):
    ...
    Returns:
        bool: 爬取是否成功
    """
    # https://www.scea.co/portal/policy/index/p/1.html
    url = f"https://www.scea.co/portal/policy/index/p/{page_num}.html"
